      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div className="relative">
            ...
            <Input placeholder="Search assignments, grades, announcements..." className="pl-10 w-80" />
          </div>
        </div>
            ...
            <DropdownMenuContent align="end" className="w-80">
              ...
              <DropdownMenuItem>
                <div className="flex flex-col space-y-1">
                  ...
                  <p className="text-xs text-gray-500">English Essay on Climate Change</p>
                </div>
              </DropdownMenuItem>
              <DropdownMenuItem>
                <div className="flex flex-col space-y-1">
                  <p className="text-sm font-medium">New Grade Posted</p>
                  <p className="text-xs text-gray-500">Mathematics Quiz - A+ (95/100)</p>
                </div>
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>

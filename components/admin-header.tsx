            ...
            <DropdownMenuContent align="end" className="w-80">
              ...
              <DropdownMenuItem>
                <div className="flex flex-col space-y-1">
                  ...
                  <p className="text-xs text-gray-500">John Doe has been enrolled in Grade 10A</p>
                </div>
              </DropdownMenuItem>
              <DropdownMenuItem>
                <div className="flex flex-col space-y-1">
                  <p className="text-sm font-medium">Low attendance alert</p>
                  <p className="text-xs text-gray-500">Class 9B attendance is below 80%</p>
                </div>
              </DropdownMenuItem>
              <DropdownMenuItem>
                <div className="flex flex-col space-y-1">
                  <p className="text-sm font-medium">Fee payment received</p>
                  <p className="text-xs text-gray-500">Sarah Smith paid $1,200 for semester fees</p>
                </div>
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
